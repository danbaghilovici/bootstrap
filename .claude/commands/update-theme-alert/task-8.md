# update-theme-alert - Task 8

Execute task 8 for the update-theme-alert specification.

## Task Description
Create demo HTML file for visual testing

## Code Reuse
**Leverage existing code**: `demo/carbon-accordion.html` as pattern
...
## Usage
```
/Task:8-update-theme-alert
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create demo HTML file for visual testing"

```
Use the @spec-task-executor agent to implement task 8: "Create demo HTML file for visual testing" for the update-theme-alert specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Create demo HTML file for visual testing
- Leverage: `demo/carbon-accordion.html` as pattern
- Requirements: All

## Instructions
- Implement ONLY task 8: "Create demo HTML file for visual testing"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-alert 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-alert 8 --mode complete
```
