# update-theme-typography - Task 4

Execute task 4 for the update-theme-typography specification.

## Task Description
Add heading font size variable overrides
...
## Usage
```
/Task:4-update-theme-typography
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add heading font size variable overrides"

```
Use the @spec-task-executor agent to implement task 4: "Add heading font size variable overrides" for the update-theme-typography specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Add heading font size variable overrides
- Leverage: scss/
- Requirements: 3.1, 3.2, 3.3, 3.4, 3.5, 3.6

## Instructions
- Implement ONLY task 4: "Add heading font size variable overrides"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 4 --mode complete
```
