# update-theme-typography - Task 13

Execute task 13 for the update-theme-typography specification.

## Task Description
Add section header comment for Carbon typography overrides
...
## Usage
```
/Task:13-update-theme-typography
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add section header comment for Carbon typography overrides"

```
Use the @spec-task-executor agent to implement task 13: "Add section header comment for Carbon typography overrides" for the update-theme-typography specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Add section header comment for Carbon typography overrides
- Requirements: 6.3, 6.4

## Instructions
- Implement ONLY task 13: "Add section header comment for Carbon typography overrides"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 13 --mode complete
```
