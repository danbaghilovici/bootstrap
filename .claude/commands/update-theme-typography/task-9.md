# update-theme-typography - Task 9

Execute task 9 for the update-theme-typography specification.

## Task Description
Add RFS variable overrides for Carbon-like responsive behavior

## Code Reuse
**Leverage existing code**: scss/vendor/

## Requirements Reference
**Requirements**: Design Decision 3

## Usage
```
/Task:9-update-theme-typography
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add RFS variable overrides for Carbon-like responsive behavior"

```
Use the @spec-task-executor agent to implement task 9: "Add RFS variable overrides for Carbon-like responsive behavior" for the update-theme-typography specification and include all the below context.
...
## Task Details
- Task ID: 9
- Description: Add RFS variable overrides for Carbon-like responsive behavior
- Leverage: scss/vendor/
- Requirements: Design Decision 3

## Instructions
- Implement ONLY task 9: "Add RFS variable overrides for Carbon-like responsive behavior"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 9 --mode complete
```
