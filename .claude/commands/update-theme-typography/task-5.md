# update-theme-typography - Task 5

Execute task 5 for the update-theme-typography specification.

## Task Description
Add heading style variable overrides
...
## Usage
```
/Task:5-update-theme-typography
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add heading style variable overrides"

```
Use the @spec-task-executor agent to implement task 5: "Add heading style variable overrides" for the update-theme-typography specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Add heading style variable overrides
- Leverage: scss/
- Requirements: 3.7

## Instructions
- Implement ONLY task 5: "Add heading style variable overrides"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 5 --mode complete
```
