# update-theme-typography - Task 11

Execute task 11 for the update-theme-typography specification.
...
## Usage
```
/Task:11-update-theme-typography
```
...
```
Use the @spec-task-executor agent to implement task 11: "Run CSS linter to verify code quality" for the update-theme-typography specification and include all the below context.
...
## Instructions
- Implement ONLY task 11: "Run CSS linter to verify code quality"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 11 --mode complete
```
