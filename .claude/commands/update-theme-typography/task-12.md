# update-theme-typography - Task 12

Execute task 12 for the update-theme-typography specification.

## Task Description
Build theme and copy to output directory
...
## Usage
```
/Task:12-update-theme-typography
```

## Instructions

Execute with @spec-task-executor agent the following task: "Build theme and copy to output directory"

```
Use the @spec-task-executor agent to implement task 12: "Build theme and copy to output directory" for the update-theme-typography specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Build theme and copy to output directory
- Requirements: 6.1

## Instructions
- Implement ONLY task 12: "Build theme and copy to output directory"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-typography 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-typography 12 --mode complete
```
