# update-theme-colors - Task 8

Execute task 8 for the update-theme-colors specification.
...
```
Use the @spec-task-executor agent to implement task 8: "Run CSS linter to verify code quality" for the update-theme-colors specification and include all the below context.
...
## Instructions
- Implement ONLY task 8: "Run CSS linter to verify code quality"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-colors 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-colors 8 --mode complete
```
