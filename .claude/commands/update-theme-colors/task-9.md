# update-theme-colors - Task 9

Execute task 9 for the update-theme-colors specification.
...
```
Use the @spec-task-executor agent to implement task 9: "Build theme and copy to output directory" for the update-theme-colors specification and include all the below context.
...
## Instructions
- Implement ONLY task 9: "Build theme and copy to output directory"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-theme-colors 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-theme-colors 9 --mode complete
```
